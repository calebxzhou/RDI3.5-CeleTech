...
object TimeUtils {
	...
	val timeChineseString: String
        get() {
            ...
            var charTime = ""
            if (hour in 0..5) charTime = "凌晨"
            if (hour in 6..8) charTime = "早上"
            if (hour in 9..10) charTime = "上午"
            if (hour in 11..12) charTime = "中午"
            if (hour in 13..17) charTime = "下午"
            if (hour in 18..23) charTime = "晚上"
            return charTime
        }
