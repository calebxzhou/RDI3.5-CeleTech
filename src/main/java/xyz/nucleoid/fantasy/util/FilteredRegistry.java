...
public class FilteredRegistry<T> extends Registry<T> {
    ...
    public FilteredRegistry(Registry<T> source, Predicate<T> check) {
        super(source.key(), source.elementsLifecycle());
        this.source = source;
        this.check = check;
    }
    ...
    public Lifecycle elementsLifecycle() {
        return this.source.elementsLifecycle();
    }
    ...
    @Override
    public Optional<Holder<T>> getRandom(net.minecraft.util.RandomSource random) {
    ...
    public Holder<T> getOrCreateHolderOrThrow(ResourceKey<T> key) {
        return this.source.getOrCreateHolderOrThrow(key);
    }
